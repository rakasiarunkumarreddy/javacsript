...
//by using the operator ?. it gives output as undefined instead of giving or throwing an error
...
console.log(obj3.b?.c);             //opt:undefined  ,if we didnt place ? after b,then we will get an error
...
x = null;
 y = x ?? 'default';                       //if the value before ?? is null or undefined,then it prints value after ??
 console.log(y)                   //opt:default,because x is equal to null

// 2. What is the result of x = undefined; y = x ?? 'default';? What is the value of y?

x = undefined;
 y = x ?? 'default';               //x is undefined
 console.log(y)

// 3. What is the result of x = 0; y = x ?? 'default';? What is the value of y?

x = 0;
y = x ?? 'default';            //x is not null or undefined,so it prints 0
console.log(y)